...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, a as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, l as lookupResultToBuffer, R as RequestStatusResponseStatus, U as UnknownError, b as RequestStatusDoneNoReplyErrorCode, c as RejectError, d as CertifiedRejectErrorCode, e as UNREACHABLE_ERROR, I as InputError, f as InvalidReadStateRequestErrorCode, g as ReadRequestType, h as Principal, i as IDL, k as MissingCanisterIdErrorCode, H as HttpAgent, m as encode, Q as QueryResponseStatus, n as UncertifiedRejectErrorCode, o as isV3ResponseBody, p as isV2ResponseBody, q as UncertifiedRejectUpdateErrorCode, s as UnexpectedErrorCode, t as decode, S as Subscribable, v as pendingThenable, w as resolveEnabled, x as shallowEqualObjects, y as resolveStaleTime, z as noop$1, A as environmentManager, B as isValidTimeout, D as timeUntilStale, F as timeoutManager, G as focusManager, J as fetchState, K as replaceData, L as notifyManager, N as hashKey, O as getDefaultState, r as reactExports, V as shouldThrowError, W as useQueryClient, u as useInternetIdentity, X as createActorWithConfig, j as jsxRuntimeExports, Y as cn, Z as Variant, _ as Record, $ as Service, a0 as Func, a1 as Opt, a2 as Null, a3 as Nat, a4 as Int, a5 as o, a6 as vt, a7 as Skeleton } from "./index-DoJZ7Rh2.js";
import { c as createLucideIcon, C as Cpu, Z as Zap, B as Button, S as Slot, a as cva } from "./zap-CrsmBaJ1.js";
...
function Layout({ children }) {
  ...
  const isAuthenticated = !!identity;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background grid-bg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "bg-card border-b border-border/60 glow-neon-green px-4 py-3 flex items-center justify-between z-10 sticky top-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-md bg-accent/10 border border-accent/40 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Cpu,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              ...
              style: { fontFamily: "var(--font-mono)" },
              children: "Cyber-Miner"
            }
          )
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden sm:flex items-center gap-1.5 px-3 py-1 rounded-full border border-accent/30 bg-accent/5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Zap,
            {
              className: "w-3 h-3",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border/40 px-4 py-3 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "p",
      {
...
Service({
  "buyUpgrade": Func([UpgradeType], [UpgradeResult], []),
  "click": Func([], [GameState], []),
  "collectCoins": Func([], [GameState], []),
  "getGameState": Func([], [GameState], []),
  "getUpgradeCost": Func([UpgradeType], [Nat], ["query"]),
  "loadGameState": Func([], [Opt(GameState)], ["query"]),
  "purchaseUpgrade": Func([UpgradeType], [UpgradeResult], []),
  "resetGameState": Func([], [], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const UpgradeType2 = IDL2.Variant({
    "cpu": IDL2.Null,
    "gpu": IDL2.Null,
    "cooling": IDL2.Null
  });
  const Timestamp2 = IDL2.Int;
  const GameState2 = IDL2.Record({
    "coolingCount": IDL2.Nat,
    "coinBalance": IDL2.Nat,
    "totalClicks": IDL2.Nat,
    "coinsPerSecond": IDL2.Nat,
    "gpuCount": IDL2.Nat,
    "lastSaveTimestamp": Timestamp2,
    "cpuCount": IDL2.Nat
  });
  const UpgradeResult2 = IDL2.Variant({
    "ok": GameState2,
    "insufficientFunds": IDL2.Record({
      "available": IDL2.Nat,
      "required": IDL2.Nat
    })
  });
  return IDL2.Service({
    "buyUpgrade": IDL2.Func([UpgradeType2], [UpgradeResult2], []),
    "click": IDL2.Func([], [GameState2], []),
    "collectCoins": IDL2.Func([], [GameState2], []),
    "getGameState": IDL2.Func([], [GameState2], []),
    "getUpgradeCost": IDL2.Func([UpgradeType2], [IDL2.Nat], ["query"]),
    "loadGameState": IDL2.Func([], [IDL2.Opt(GameState2)], ["query"]),
    "purchaseUpgrade": IDL2.Func([UpgradeType2], [UpgradeResult2], []),
    "resetGameState": IDL2.Func([], [], [])
  });
};
class Backend {
  ...
  async buyUpgrade(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.buyUpgrade(to_candid_UpgradeType_n1(this._uploadFile, this._downloadFile, arg0));
        return from_candid_UpgradeResult_n3(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
  ...
  async collectCoins() {
    if (this.processError) {
      try {
        const result = await this.actor.collectCoins();
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async getUpgradeCost(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.getUpgradeCost(to_candid_UpgradeType_n1(this._uploadFile, this._downloadFile, arg0));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async purchaseUpgrade(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.purchaseUpgrade(to_candid_UpgradeType_n1(this._uploadFile, this._downloadFile, arg0));
        return from_candid_UpgradeResult_n3(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async resetGameState() {
    if (this.processError) {
      try {
        const result = await this.actor.resetGameState();
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
...
function from_candid_UpgradeResult_n3(_uploadFile, _downloadFile, value) {
...
function to_candid_UpgradeType_n1(_uploadFile, _downloadFile, value) {
...
const UPGRADE_CONFIGS = [
  {
    key: "cpu",
    label: "Quantum CPU",
    description: "Next-gen processor that extracts Hash Coins via quantum computation.",
    baseCpsBoost: 5n,
    icon: "cpu"
  },
  {
    key: "gpu",
    label: "Voltaic GPU",
    description: "High-voltage graphics unit for parallel hash rendering at terahash speeds.",
    baseCpsBoost: 20n,
    icon: "gpu"
  },
  {
    ...
    description: "Cryo-loop cooling system that keeps your rig running at peak efficiency.",
    baseCpsBoost: 2n,
    icon: "cooling"
  }
];
...
function useUpgrade() {
  ...
  const mutation = useMutation({
    mutationFn: async (key) => {
      ...
      return actor.purchaseUpgrade(upgradeType);
    },
    onSuccess: (result) => {
      if ("ok" in result) {
        queryClient.setQueryData(queryKey, result.ok);
        ue.success("Upgrade purchased!", {
  ...
  const getUpgradeCost2 = async (key) => {
    if (!actor) return 0n;
    try {
      const upgradeType = makeUpgradeType(key);
      return actor.getUpgradeCost(upgradeType);
    } catch {
      return 0n;
    }
  };
  return {
    purchase: (key) => mutation.mutate(key),
    isPurchasing: mutation.isPending,
    pendingKey: mutation.variables,
    getUpgradeCost: getUpgradeCost2
  };
}
...
function getUpgradeCost(key, owned) {
  return BigInt(Math.floor(Number(BASE_COSTS[key]) * 1.15 ** Number(owned)));
}
function getOwnedCount(state, key) {
...
function UpgradeIcon({ icon }) {
  const cls = "w-7 h-7";
  if (icon === "gpu") return /* @__PURE__ */ jsxRuntimeExports.jsx(Layers, { className: cls });
  if (icon === "cooling") return /* @__PURE__ */ jsxRuntimeExports.jsx(Thermometer, { className: cls });
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Cpu, { className: cls });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Card,
        {
          className: `p-4 border transition-smooth flex flex-col gap-3 ${canAfford ? "border-accent/50 bg-card glow-neon-green" : "border-border/30 bg-card/60"}`,
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: `w-11 h-11 rounded-lg flex items-center justify-center flex-shrink-0 border ${canAfford ? "border-accent/50 bg-accent/10 text-glow-accent" : "border-border/30 bg-muted/30 text-muted-foreground"}`,
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(UpgradeIcon, { icon })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-mono font-bold uppercase tracking-wider", children: label }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5 line-clamp-2 font-mono", children: description })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2 pt-1 border-t border-border/20", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-3 h-3 flex-shrink-0 text-glow-accent" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-mono font-bold text-glow-accent tabular-nums", children: [
                  formatCoins(cost),
                  " HC"
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  className: `h-7 text-xs font-mono font-bold uppercase tracking-wider transition-smooth ${canAfford ? "bg-accent text-accent-foreground hover:bg-accent/80" : "opacity-40 cursor-not-allowed bg-muted text-muted-foreground"}`,
                  "data-ocid": `upgrade-buy-${upgradeKey}`,
                  children: isPurchasing ? "…" : "Upgrade"
                }
              )
            ] })
          ]
...
function StatRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline justify-between gap-2 py-2 border-b border-border/20 last:border-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-muted-foreground uppercase tracking-wider", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
...
function Game() {
  ...
  const [localBalance, setLocalBalance] = reactExports.useState(0n);
  const localBalanceRef = reactExports.useRef(0n);
  reactExports.useEffect(() => {
    if (serverState) {
  ...
  const [flashes, setFlashes] = reactExports.useState([]);
  const flashIdRef = reactExports.useRef(0);
  const handleMine = (e) => {
    const rect = e.currentTarget.getBoundingClientRect();
    const x = e.clientX - rect.left;
    const y = e.clientY - rect.top;
    const id2 = ++flashIdRef.current;
    setFlashes((prev) => [...prev, { id: id2, x, y }]);
    setTimeout(
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 rounded-full border-2 border-accent/50 glow-neon-green flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Cpu,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 w-56 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-5 w-full mx-auto" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-3/4 mx-auto" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-muted-foreground uppercase tracking-widest", children: "Syncing rig state…" })
        ]
      }
    ) });
  }
  if (isError) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-14 h-14 text-destructive" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-mono font-bold uppercase tracking-wider text-destructive", children: "Node Offline" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-mono text-muted-foreground max-w-sm", children: "Could not connect to the mining network. Check your connection and try again." })
        ]
      }
    ) });
  }
  const state = serverState;
  const rigPower = state.cpuCount * 1n + state.gpuCount * 5n + state.coolingCount * 15n;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      "data-ocid": "game-main",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: "lg:w-56 xl:w-64 bg-card/80 border-b lg:border-b-0 lg:border-r border-border/40 p-4 flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xs font-mono uppercase tracking-widest text-muted-foreground mb-3", children: "System Stats" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "stats-panel", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  StatRow,
                  {
                    label: "Coins/Sec",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 flex flex-col items-center justify-center gap-8 p-6 lg:p-10 bg-background", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              initial: { scale: 1 },
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono uppercase tracking-widest text-muted-foreground mb-1", children: "Hash Coin Balance" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-4xl lg:text-5xl xl:text-6xl font-mono font-bold text-glow-accent tabular-nums", children: [
                  formatCoins(localBalance),
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl lg:text-3xl text-muted-foreground", children: "HC" })
                ] })
              ]
            },
            ...
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    ...
                    style: {
                      ...
                      background: "conic-gradient(from 0deg, transparent 260deg, oklch(var(--accent)/0.35) 360deg)"
                    }
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-5 rounded-full border border-accent/15 bg-accent/5" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "relative z-10 flex flex-col items-center gap-1", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono font-bold text-glow-accent uppercase tracking-widest", children: isMining ? "Mining…" : "Mine" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: flashes.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.span,
                  {
                    initial: {
                      opacity: 1,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-mono text-muted-foreground text-center", children: [
            "Click to mine · Passive:",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-glow-accent", children: [
              formatCoins(state.coinsPerSecond),
              " HC/sec"
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "lg:w-72 xl:w-80 bg-card/80 border-t lg:border-t-0 lg:border-l border-border/40 p-4 flex-shrink-0 overflow-y-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xs font-mono uppercase tracking-widest text-muted-foreground mb-3", children: "Upgrade Shop" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", "data-ocid": "upgrade-shop", children: UPGRADE_CONFIGS.map((cfg) => {
